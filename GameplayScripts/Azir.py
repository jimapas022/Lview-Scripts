...
def soldiercheck(game):
    ...
    for others in game.others:
        if i < 3 and others.name == "azirsoldier" and others.is_alive:
            i += 1
    return i
...
def Shurima(game):
    ...
    for others in game.others:
        if others.name == "azirsoldier" and soldierDist < 1100 and others.is_alive:
...
def Revenant(game):
    ...
    for others in game.others:
        if others.name == "azirsoldier" and soldierDist < 2000 and others.is_alive:
            if (game.player.pos.distance(others.pos) > soldierDist):
                soldierDist = game.player.pos.distance(others.pos)
                soldier = others
