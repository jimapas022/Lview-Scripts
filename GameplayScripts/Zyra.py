...
def Combo(game):
    ...
    if use_w_in_combo and IsReady(game, w_spell) and IsReady(game, e_spell) or IsReady(game, q_spell) :
    ...
    if use_r_in_combo and IsReady(game, r_spell) :
                targetR=GetBestTargetsInRange(game,700)
                if targetR:
