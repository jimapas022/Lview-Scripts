...
def Combo(game):
    ...
    if use_q_in_combo and IsReady(game, q_spell) :
                ...
                if targetQ :
                            ...
                            if game.player.pos.distance (predicted_target.pos) <= 1300 and not IsCollisioned(game, predicted_target) :
